DATA_FILEPATH = r'C:\Users\Anish Kumar Verma\PycharmProjects\AutoEDA\temp_uploads\abalone.data.csv'
...
predictive_blueprint = {
  ...
  "executive_summary": "Target: 'Rings' (Regression). Model recommendations and validation strategy tailored for 4177 rows x 9 columns."
}
