DATA_FILEPATH = r'C:\Users\Anish Kumar Verma\PycharmProjects\AutoEDA\temp_uploads\modified_data.csv'
...
predictive_blueprint = {
  ...
  "executive_summary": "Target: price (Regression). Use robust cross-validation on 4600 rows x 18 columns."
}
