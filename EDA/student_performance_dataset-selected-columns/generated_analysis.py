DATA_FILEPATH = r'C:\Users\Anish Kumar Verma\PycharmProjects\AutoEDA\temp_uploads\student_performance_dataset-selected-columns.csv'
...
predictive_blueprint = {
  "target_definition": "previous_grade",
  ...
  "executive_summary": "Target: previous_grade (Regression). Use robust cross-validation on 1000 rows x 10 columns."
}
