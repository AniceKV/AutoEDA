DATA_FILEPATH = r'C:\Users\Anish Kumar Verma\PycharmProjects\AutoEDA\temp_uploads\BankNoteAuthentication.csv'
...
predictive_blueprint = {
  ...
  "executive_summary": "Target: 'class' (Binary Classification). Model recommendations and validation strategy tailored for 1372 rows x 5 columns."
}
